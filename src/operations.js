...
export const OPERATIONS = [
  ...
  op('createSlackConnectionSession', 'slack connect', 'POST', '/account/slack-connection-sessions', { idempotent: true }),
  op('getSlackConnectionSession', 'slack sessions show', 'GET', '/account/slack-connection-sessions/{session_id}'),
  op('disconnectSlackConnection', 'slack disconnect', 'DELETE', '/account/slack-connection', { body: true, idempotent: true, confirm: true }),
