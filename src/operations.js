...
export const OPERATIONS = [
  ...
  op('getAnalyticsReport', 'analytics report', 'GET', '/workspaces/{workspace_id}/analytics'),
  op('getPostAnalytics', 'analytics show --post', 'GET', '/workspaces/{workspace_id}/analytics/posts/{post}'),
  op('refreshPostAnalytics', 'analytics refresh --post', 'POST', '/workspaces/{workspace_id}/analytics/posts/{post}/refresh', { idempotent: true }),
  op('getPostGroupAnalytics', 'analytics show --group', 'GET', '/workspaces/{workspace_id}/analytics/post-groups/{group}'),
  op('refreshPostGroupAnalytics', 'analytics refresh --group', 'POST', '/workspaces/{workspace_id}/analytics/post-groups/{group}/refresh', { idempotent: true }),
